...
?>
  ...
  <main class="page-main page-fullpage main-anim" id="itempage">
    ...
    <div class="section section-twoside fp-auto-height-responsive section-item" data-section="item-alpha" style="<?php echo $bg_performance; ?>">
     
      <div class="section-cover-tier mask-black fixPosition" style="background-image:url('../img/projects/performance.jpg')">
          ...
          <div class="col-12 col-md-8 center-vh">
            ...
            <div class="section-content anim scrollable">
              ...
              <article id="touchsurface" class="article article-light">
                <div class="article-content">
                  ...
                  <div class="wrapper">
                    ...
                    <h5><?php echo $performance_h1; ?></h5>
                                       
                    <p><?php echo $performance_p1; ?></p>
                    
                    <p><i class="icon ion-camera"></i><?php echo $performance_p2; ?><br>
                    <i class="icon ion-thumbsup"></i><?php echo $performance_p3; ?><br>
                    <i class="icon ion-ios-analytics"></i><?php echo $performance_p4; ?><p>
                    
                    <h5><?php echo $performance_h2; ?></h5>
                    
                    <p><i class="icon ion-arrow-graph-up-right"></i><?php echo $performance_p5; ?></p>
              ...
              <div class="btns-action mt-4">
                <a class="btn btn-transp-arrow btn-primary icon-left btn-outline btn-round" href="oportunidades.php">
                  <span class="icon arrow-left"></span>
                  <span class="text"><?php echo $prev_btn; ?></span>
                </a>
                <a class="btn btn-transp-arrow btn-primary btn-outline btn-round" href="riscos.php">
 ...
 <script src="../js/jquery.downCount.js"></script>
  ...
  <script type="text/javascript">
      window.proximo = "./riscos.php";
      window.anterior = "./oportunidades.php";
    </script>
