...
?>
  ...
  <main class="page-main page-fullpage main-anim" id="itempage">
    ...
    <div class="section section-twoside fp-auto-height-responsive section-item" data-section="item-alpha" style="background: rgb(92,24,0);">
      <div class="section-cover-tier mask-black team" style="background-image:url('../img/team/tassia.jpg')">
          ...
          <div class="col-12 col-md-8 center-vh">
            ...
            <div class="section-content anim scrollable">
              ...
              <article id="touchsurface" class="article article-light">
                <header class="article-header">
                  <div class="wrapper">
                    <div class="media media-article-title">
                      ...
                      <img class="media-image d-flex align-self-center mr-3" src="../img/team/thumb/_tassia.png"
                      alt="Tássia Bittar">
                      
                      <div class="media-body align-self-center">
                       
                        <h5 class="mt-0 media-title">
                          <strong>Tássia Bittar</strong>
                        </h5>
                        
                        <p class="mb-0">Qualitative Research Consultant</p>
                        
                        <p class="mb-0 t-nowrap"><a href="mailto:tassia@ginger.com.br">tassia@ginger.com.br</a></p>
                        
                        <div class="icons">
                            <a class="icon-btn" href="skype:tassia.bittar?chat">
                ...
                <div class="article-content">
                  ...
                  <div class="wrapper">
                    ...
                    <p><?php echo $tassia_p1; ?></p>                    
                    <p><?php echo $tassia_p2; ?></p>                    
                    <p><?php echo $tassia_p3; ?></p>
              ...
              <div class="btns-action mt-4">
                <a class="btn btn-transp-arrow btn-primary icon-left btn-outline btn-round" href="laure.php">
                  <span class="icon arrow-left"></span>
                  <span class="text"><?php echo $prev_btn; ?></span>
                </a>
                <a class="btn btn-transp-arrow btn-primary btn-outline btn-round" href="dani.php">
 ...
 <script src="../js/jquery.downCount.js"></script>
  ...
  <script type="text/javascript">
      window.proximo = "./dani.php";
      window.anterior = "./laure.php";
    </script>
