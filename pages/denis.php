...
?>
  ...
  <main class="page-main page-fullpage main-anim" id="itempage">
    ...
    <div class="section section-twoside fp-auto-height-responsive section-item" data-section="item-alpha" style="background: rgb(50,30,18);">
      <div class="section-cover-tier mask-black team" style="background-image:url('../img/team/denis.jpg')">
          ...
          <div class="col-12 col-md-8 center-vh">
            ...
            <div class="section-content anim scrollable">
              ...
              <article id="touchsurface" class="article article-light">
                <header class="article-header">
                  <div class="wrapper">
                    <div class="media media-article-title">
                      ...
                      <img class="media-image d-flex align-self-center mr-3" src="../img/team/thumb/_denis.png"
                      alt="Denis Nascimento">
                      
                      <div class="media-body align-self-center">
                       
                        <h5 class="mt-0 media-title">
                          <strong>Denis Nascimento</strong>
                        </h5>
                        
                        <p class="mb-0">Quantitative Research Consultant</p>
                        
                        <p class="mb-0 t-nowrap"><a href="mailto:denis@ginger.com.br">denis@ginger.com.br</a></p>
                        
                        <div class="icons">
                            <a class="icon-btn" href="skype:denisnascimento_3?chat">
                ...
                <div class="article-content">
                  ...
                  <div class="wrapper">
                    ...
                    <p><?php echo $denis_p1; ?></p>                    
                    <p><?php echo $denis_p2; ?></p>                    
                    <p><?php echo $denis_p3; ?></p>
              ...
              <div class="btns-action mt-4">
                <a class="btn btn-transp-arrow btn-primary icon-left btn-outline btn-round" href="alejandrina.php">
                  <span class="icon arrow-left"></span>
                  <span class="text"><?php echo $prev_btn; ?></span>
                </a>
                <a class="btn btn-transp-arrow btn-primary btn-outline btn-round" href="laure.php">
 ...
 <script src="../js/jquery.downCount.js"></script>
  ...
  <script type="text/javascript">
      window.proximo = "./laure.php";
      window.anterior = "./alejandrina.php";
    </script>
