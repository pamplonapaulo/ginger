...
define("TITLE", $ana_costa);
define("SECTION", $team);
define("CSS_INSIDE_PAGES", $css_team);
define("BODY_BG", $bg_ana_costa);
...
?>
  ...
  <main class="page-main page-fullpage main-anim" id="itempage">
    ...
    <div class="section section-twoside fp-auto-height-responsive section-item" data-section="item-alpha" style="background: rgb(147,90,34);">
      <div class="section-cover-tier mask-black team" style="background-image:url('../img/team/ana_costa.jpg')">
          ...
          <div class="col-12 col-md-8 center-vh">
            ...
            <div class="section-content anim scrollable">
              ...
              <article id="touchsurface" class="article article-light">
                <header class="article-header">
                  <div class="wrapper">
                    <div class="media media-article-title">
                      ...
                      <img class="media-image d-flex align-self-center mr-3" src="../img/team/thumb/_ana_costa.png"
                      alt="Ana Cristina Costa">
                      
                      <div class="media-body align-self-center">
                       
                        <h5 class="mt-0 media-title">
                          <strong>Ana Cristina Costa</strong>
                        </h5>
                        
                        <p class="mb-0">Qualitative Research Consultant</p>
                        
                          <p class="mb-0 t-nowrap"><a href="mailto:anacosta@ginger.com.br">anacosta@ginger.com.br</a></p>
                        
                        <div class="icons">
                            <a class="icon-btn" href="skype:anacosta.ginger.br?chat">
                ...
                <div class="article-content">
                  ...
                  <div class="wrapper">
                    ...
                    <p><?php echo $ana_costa_p1; ?></p>                    
                    <p><?php echo $ana_costa_p2; ?></p>                    
                    <p><?php echo $ana_costa_p3; ?></p>
              ...
              <div class="btns-action mt-4">
                <a class="btn btn-transp-arrow btn-primary icon-left btn-outline btn-round" href="mariana.php">
                  <span class="icon arrow-left"></span>
                  <span class="text"><?php echo $prev_btn; ?></span>
                </a>
                <a class="btn btn-transp-arrow btn-primary btn-outline btn-round" href="clara.php">
 ...
 <script src="../js/jquery.downCount.js"></script>
  ...
  <script type="text/javascript">
      window.proximo = "./clara.php";
      window.anterior = "./mariana.php";
    </script>
