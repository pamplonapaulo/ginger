...
?>
  ...
  <main class="page-main page-fullpage main-anim" id="itempage">
    ...
    <div class="section section-twoside fp-auto-height-responsive section-item" data-section="item-alpha" style="background: rgb(239,127,2);">
      <div class="section-cover-tier mask-black team" style="background-image:url('../img/team/clara.jpg')">
          ...
          <div class="col-12 col-md-8 center-vh">
            ...
            <div class="section-content anim scrollable">
              ...
              <article id="touchsurface" class="article article-light">
                <header class="article-header">
                  <div class="wrapper">
                    <div class="media media-article-title">
                      ...
                      <img class="media-image d-flex align-self-center mr-3" src="../img/team/thumb/_clara.png"
                      alt="Clara Dias Kolhy">
                      
                      <div class="media-body align-self-center">
                       
                        <h5 class="mt-0 media-title">
                          <strong>Clara Dias Kolhy</strong>
                        </h5>
                        
                        <p class="mb-0 t-nowrap">Commercial</p>
                        
                        <p class="mb-0 t-nowrap"><a href="mailto:clara@ginger.com.br">clara@ginger.com.br</a></p>
                        
                        <div class="icons">
                            <a class="icon-btn" href="skype:mariaclara.ginger?chat">
                ...
                <div class="article-content">
                  ...
                  <div class="wrapper">
                    ...
                    <p><?php echo $clara_p1; ?></p>                    
                    <p><?php echo $clara_p2; ?></p>                    
                    <p><?php echo $clara_p3; ?></p>
              ...
              <div class="btns-action mt-4">
                <a class="btn btn-transp-arrow btn-primary icon-left btn-outline btn-round" href="ana_costa.php">
                  <span class="icon arrow-left"></span>
                  <span class="text"><?php echo $prev_btn; ?></span>
                </a>
                <a class="btn btn-transp-arrow btn-primary btn-outline btn-round" href="maisa.php">
 ...
 <script src="../js/jquery.downCount.js"></script>
  ...
  <script type="text/javascript">
      window.proximo = "./maisa.php";
      window.anterior = "./ana_costa.php";
    </script>
